...
<button
  ref={ref}
  onClick={onClick}
  className={`cursor-pointer select-none bg-[#FFD700] hover:bg-[#FFC400] text-black font-black py-6 px-8 rounded-lg text-2xl md:text-3xl uppercase tracking-tighter shadow-[0_10px_0_0_#B8860B] active:shadow-none active:translate-y-[10px] transition-all transform hover:scale-105 ${className}`}
>
  {children}
</button>
));
...
const scrollToDownload = () => {
  ...
  GET THE EBOOK NOW
        ...
        <div className="mt-24 text-gray-600 text-sm">
          ...
          <br />
  <script type="text/javascript" src="https://warriorplus.com/o2/disclaimer/x2qlr4" defer></script><div style="height:3px;font-size:1px;line-height:0px;color:#FFFFFF;" class="wplus_spdisclaimer"></div>
        </div>
      </Section>
